...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Pemakaian Barang</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ket_pakai" class="form-control" placeholder="keterangan pakai"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="tgl_pakai" data-target-input="nearest">
                                <input type="text" name="tgl_pakai" class="form-control datetimepicker-input"
                                    data-target="#tgl_pakai" required="" autocomplete="off" />
